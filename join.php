<?php 
		...
		iconv_set_encoding("internal_encoding", "UTF-8");
			...
			if($_POST)
				...
				mysql_query("INSERT INTO dedicaces (song, nom_from, nom_for, ville_from, ville_for, email_from, email_for, message , type , joignable, created_on) VALUES ( '".$song."','".$nom_from."', '".$nom_for."', '".$ville_from."', '".$ville_for."', '".$email_from."', '".$email_for."', '".$message_raw."', '".$type."' , '".$joindre."' , '".$created_on."')")or die(mysql_error());
				...
				mysql_close($connecDB);
				 	...
				 	if ($type == 1) {
						...
						$subject = $nom_for;
						$subject .=  ", une dédicace de " . $nom_from." pour toi sur radio AdventLife"; 
						...
						$message2 .= " <br /><br /> *** Pour modérer ce message cliquer ici : http://www.adventlife.fr/adventradio/mod.php?mod=" . urlencode($created_on)  ;
						...
						{ 
							...
							mail('bluebird972@gmail.com', 'Nouvelle Dédicace sur RADIO AdventLife', $message2, $headers);
						}  
						else  
						{ 
				 	...
				 	//IF priere ou temoignage
						...
						$headers .= "Reply-To: Adventlife <contact@adventlife.fr>";
							...
							echo "answer=ok"; 
							mail('bluebird972@gmail.com, mperonet@gmail.com', 'Nouvelle requete de prière ou témoignage sur RADIO AdventLife', $message2, $headers);
